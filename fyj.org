...
** 设置exec path
   ...
   #+BEGIN_SRC emacs-lisp 
     (if *is-a-windows*
       (fyj/org-load "exec-path" "Windows"))
   #+END_SRC

** 加载常用函数

  #+begin_src emacs-lisp
  (fyj/org-load "fyj-defuns.org")
  #+end_src

** 加载实用函数

  #+BEGIN_SRC emacs-lisp 
    (fyj/org-load "fyj-utils.org")
  #+END_SRC

** 按键设置 

  #+begin_src emacs-lisp
  (fyj/org-load "bindings")
  #+end_src

** 杂项设置

  #+begin_src emacs-lisp 
  (fyj/org-load "fyj-misc.org")
  #+end_src
   
** register设置

  #+begin_src emacs-lisp
  (fyj/org-load "fyj-registers.org")
  #+end_src
